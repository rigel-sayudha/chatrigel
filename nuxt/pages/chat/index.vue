...
const suggestions = [
  ...
  { icon: 'i-simple-icons-javascript', label: 'Explain async/await in JS', prompt: 'Explain how async/await works in JavaScript with examples' },
  ...
  { icon: 'i-lucide-sun', label: 'What is the weather in Paris?', prompt: 'What is the weather like in Paris right now?' },
  { icon: 'i-lucide-bar-chart-2', label: 'Show me a chart of sales data', prompt: 'Show me a sample bar chart of monthly sales data' },
]
    ...
    <div class="w-full max-w-[600px]">
      <div class="rounded-xl border border-gray-200 dark:border-white/15 bg-white dark:bg-[#27272a] overflow-hidden shadow-xs">
        ...
        <div class="flex items-center gap-2 px-3 py-2 border-t border-gray-100 dark:border-white/10">
          <!-- Paperclip -->
          <button class="w-7 h-7 flex items-center justify-center rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
